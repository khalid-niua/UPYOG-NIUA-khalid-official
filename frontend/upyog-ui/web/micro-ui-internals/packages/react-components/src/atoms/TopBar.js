    ...
    <div className="navbar">
      <div className="center-container back-wrapper" style={{display:"flex",marginRight:"2rem",marginLeft:"2rem",justifyContent:"space-between"}}>
        ...
        <div className="RightMostTopBarOptions">
          ...
          <a href="https://www.digitalpublicgoods.net/r/urban-platform-for-delivery-of-online-governance" target="_blank" >
            <img
              ...
              style={{display: "inline-block", height: "30px", padding: "0px", background: "white", borderRadius: "999px", width: "100px"}}
            />
          </a>
